...
public class RecyclerProductAdapter extends RecyclerView.Adapter<RecyclerProductAdapter.ViewHolder> implements Filterable
{
    ...
    //Adapter constructor
    RecyclerProductAdapter(Context context, ArrayList<Product> product, RecyclerProductInterface recyclerProductInterface){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sale_items,parent,false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        //OnClick awoking function through interface
        @Override
        public void onClick(View v) {
        recyclerProductInterface.onProductClick(getAdapterPosition());
        }
    }
